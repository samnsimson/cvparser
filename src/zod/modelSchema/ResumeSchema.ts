...
export const ResumeOptionalDefaultsSchema = ResumeSchema.merge(
    z.object({
...
export const ResumeWithRelationsSchema: z.ZodType<ResumeWithRelations> = ResumeSchema.merge(
    z.object({
...
export const ResumeOptionalDefaultsWithRelationsSchema: z.ZodType<ResumeOptionalDefaultsWithRelations> = ResumeOptionalDefaultsSchema.merge(
    z.object({
...
export const ResumePartialWithRelationsSchema: z.ZodType<ResumePartialWithRelations> = ResumePartialSchema.merge(
    z.object({
...
export const ResumeOptionalDefaultsWithPartialRelationsSchema: z.ZodType<ResumeOptionalDefaultsWithPartialRelations> = ResumeOptionalDefaultsSchema.merge(
    z
        .object({
            candidate: z.lazy(() => CandidatePartialWithRelationsSchema).nullish(),
            jobs: z.lazy(() => JobsAndResumesPartialWithRelationsSchema).array(),
...
export const ResumeWithPartialRelationsSchema: z.ZodType<ResumeWithPartialRelations> = ResumeSchema.merge(
    z
        .object({
            candidate: z.lazy(() => CandidatePartialWithRelationsSchema).nullish(),
            jobs: z.lazy(() => JobsAndResumesPartialWithRelationsSchema).array(),
