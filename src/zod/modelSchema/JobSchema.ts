...
export const JobOptionalDefaultsSchema = JobSchema.merge(
    z.object({
...
export const JobWithRelationsSchema: z.ZodType<JobWithRelations> = JobSchema.merge(
    z.object({
...
export const JobOptionalDefaultsWithRelationsSchema: z.ZodType<JobOptionalDefaultsWithRelations> = JobOptionalDefaultsSchema.merge(
    z.object({
...
export const JobPartialWithRelationsSchema: z.ZodType<JobPartialWithRelations> = JobPartialSchema.merge(
    z.object({
...
export const JobOptionalDefaultsWithPartialRelationsSchema: z.ZodType<JobOptionalDefaultsWithPartialRelations> = JobOptionalDefaultsSchema.merge(
    z
        .object({
            department: z.lazy(() => DepartmentPartialWithRelationsSchema),
            createdBy: z.lazy(() => UserPartialWithRelationsSchema),
...
export const JobWithPartialRelationsSchema: z.ZodType<JobWithPartialRelations> = JobSchema.merge(
    z
        .object({
            department: z.lazy(() => DepartmentPartialWithRelationsSchema),
            createdBy: z.lazy(() => UserPartialWithRelationsSchema),
