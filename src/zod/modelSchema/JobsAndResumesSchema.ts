...
export const JobsAndResumesWithRelationsSchema: z.ZodType<JobsAndResumesWithRelations> = JobsAndResumesSchema.merge(
    z.object({
...
export const JobsAndResumesOptionalDefaultsWithRelationsSchema: z.ZodType<JobsAndResumesOptionalDefaultsWithRelations> =
    JobsAndResumesOptionalDefaultsSchema.merge(
        z.object({
...
export const JobsAndResumesPartialWithRelationsSchema: z.ZodType<JobsAndResumesPartialWithRelations> = JobsAndResumesPartialSchema.merge(
    z.object({
...
export const JobsAndResumesOptionalDefaultsWithPartialRelationsSchema: z.ZodType<JobsAndResumesOptionalDefaultsWithPartialRelations> =
    JobsAndResumesOptionalDefaultsSchema.merge(
        z
            .object({
                job: z.lazy(() => JobPartialWithRelationsSchema),
...
export const JobsAndResumesWithPartialRelationsSchema: z.ZodType<JobsAndResumesWithPartialRelations> = JobsAndResumesSchema.merge(
    z
        .object({
            job: z.lazy(() => JobPartialWithRelationsSchema),
            resume: z.lazy(() => ResumePartialWithRelationsSchema),
