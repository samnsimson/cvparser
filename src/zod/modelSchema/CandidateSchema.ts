...
export const CandidateSchema = z.object({
    ...
    phone: z
        .string()
        .regex(new RegExp(/^\+?[1-9]\d{9,14}$/), "Phone number is invalid")
        .nullish(),
...
export const CandidateOptionalDefaultsSchema = CandidateSchema.merge(
    z.object({
...
export type CandidateWithRelations = Omit<
    z.infer<typeof CandidateSchema>,
    "jobExperience" | "totalExperience" | "relevantExperience" | "skills" | "pros" | "cons"
> & {
...
export const CandidateWithRelationsSchema: z.ZodType<CandidateWithRelations> = CandidateSchema.merge(
    z.object({
...
export type CandidateOptionalDefaultsWithRelations = Omit<
    z.infer<typeof CandidateOptionalDefaultsSchema>,
    "jobExperience" | "totalExperience" | "relevantExperience" | "skills" | "pros" | "cons"
> & {
    jobExperience?: JsonValueType | null;
    totalExperience?: JsonValueType | null;
...
export const CandidateOptionalDefaultsWithRelationsSchema: z.ZodType<CandidateOptionalDefaultsWithRelations> = CandidateOptionalDefaultsSchema.merge(
    z.object({
...
export type CandidatePartialWithRelations = Omit<
    z.infer<typeof CandidatePartialSchema>,
    "jobExperience" | "totalExperience" | "relevantExperience" | "skills" | "pros" | "cons"
> & {
    jobExperience?: JsonValueType | null;
    totalExperience?: JsonValueType | null;
...
export const CandidatePartialWithRelationsSchema: z.ZodType<CandidatePartialWithRelations> = CandidatePartialSchema.merge(
    z.object({
...
export type CandidateOptionalDefaultsWithPartialRelations = Omit<
    z.infer<typeof CandidateOptionalDefaultsSchema>,
    "jobExperience" | "totalExperience" | "relevantExperience" | "skills" | "pros" | "cons"
> & {
    jobExperience?: JsonValueType | null;
...
export const CandidateOptionalDefaultsWithPartialRelationsSchema: z.ZodType<CandidateOptionalDefaultsWithPartialRelations> =
    CandidateOptionalDefaultsSchema.merge(
        z
            .object({
                resume: z.lazy(() => ResumePartialWithRelationsSchema).array(),
                jobs: z.lazy(() => CandidatesOnJobsPartialWithRelationsSchema).array(),
...
export type CandidateWithPartialRelations = Omit<
    z.infer<typeof CandidateSchema>,
    "jobExperience" | "totalExperience" | "relevantExperience" | "skills" | "pros" | "cons"
> & {
    jobExperience?: JsonValueType | null;
...
export const CandidateWithPartialRelationsSchema: z.ZodType<CandidateWithPartialRelations> = CandidateSchema.merge(
    z
        .object({
            resume: z.lazy(() => ResumePartialWithRelationsSchema).array(),
            jobs: z.lazy(() => CandidatesOnJobsPartialWithRelationsSchema).array(),
