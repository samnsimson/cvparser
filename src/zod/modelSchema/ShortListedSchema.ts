...
export const ShortListedOptionalDefaultsSchema = ShortListedSchema.merge(
    z.object({
...
export const ShortListedWithRelationsSchema: z.ZodType<ShortListedWithRelations> = ShortListedSchema.merge(
    z.object({
...
export const ShortListedOptionalDefaultsWithRelationsSchema: z.ZodType<ShortListedOptionalDefaultsWithRelations> = ShortListedOptionalDefaultsSchema.merge(
    z.object({
...
export const ShortListedPartialWithRelationsSchema: z.ZodType<ShortListedPartialWithRelations> = ShortListedPartialSchema.merge(
    z.object({
...
export const ShortListedOptionalDefaultsWithPartialRelationsSchema: z.ZodType<ShortListedOptionalDefaultsWithPartialRelations> =
    ShortListedOptionalDefaultsSchema.merge(
        z
            .object({
                user: z.lazy(() => UserPartialWithRelationsSchema),
                candidate: z.lazy(() => CandidatePartialWithRelationsSchema),
...
export const ShortListedWithPartialRelationsSchema: z.ZodType<ShortListedWithPartialRelations> = ShortListedSchema.merge(
    z
        .object({
            user: z.lazy(() => UserPartialWithRelationsSchema),
            candidate: z.lazy(() => CandidatePartialWithRelationsSchema),
